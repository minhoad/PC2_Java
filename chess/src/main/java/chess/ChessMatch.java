...
public class ChessMatch {
	...
	public ChessPiece replacePromotedPiece(String type) {
		if (promoted == null) {
			throw new IllegalStateException("Não há peças para a promoção.");
		}
	...
	private void validateSourcePosition(Position position) {
		...
		if (!board.piece(position).isThereAnyPossibleMove()) {
			throw new ChessException("Não é possivel esse movimento.");
		}
	}
	...
	private ChessPiece king(Color color) {
		...
		throw new IllegalStateException((color==color.WHITE)?"Não há rei branco no tabuleiro.":"Não há rei preto no tabuleiro.");
	}
